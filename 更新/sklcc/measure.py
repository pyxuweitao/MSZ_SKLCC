...
def measure_commit( request ):
	try:
		...
		#data = [{u'serialno': u'2f491aa1-c369-11e4-8814-240a64ea4054', u'model': u'NS12355-11001-1', u'res': [{u'data': [u'1', u'2'], u'name': u'\u5e95\u56f4\u603b\u957f'}, {u'data': [u'7', u'8'], u'name': u'\u5e95\u56f4\u603b\u957f'}, {u'data': [u'3', u'4'], u'name': u'\u630e\u62e6\u603b\u957f'}, {u'data': [u'90', u'1'], u'name': u'\u630e\u62e6\u603b\u957f'}, {u'data': [u'5', u'6'], u'name': u'\u7897\u53e3\u5c3a\u5bf8'}, {u'data': [u'2', u'3'], u'name': u'\u7897\u53e3\u5c3a\u5bf8'}], u'size': u'175/100'}]
		print data
		for one in data:
			print '======='
			print one
