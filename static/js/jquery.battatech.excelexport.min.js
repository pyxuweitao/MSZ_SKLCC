(function ($) {
    ...
    $.fn.btechco_excelexport = function (options) {
        ...
        function ConvertDataStructureToTable() {
            ...
            $(gridData).each(function (key, value) {
                ...
                $($settings.columns).each(function (k, v) {
                    if (value.hasOwnProperty(this.datafield)) if (this.ishidden != true) {
                        result += "<td";
                        if (this.width != null) result += " style='width: " + this.width + "'";
                        result += ">";
        ...
        function Export(htmltable) {
            var excelFile = "<hh xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:x='urn:schemas-microsoft-com:office:excel' xmlns='http://www.w3.org/TR/REC-html40'>";
