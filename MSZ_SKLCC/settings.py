...
# although not all choices may be available on all operating systems.# In a Windows environment this must be set to your system time zone.
...
#STATIC_ROOT = 'E:/2 - course/sklcc/webserver/msz/MSZ_SKLCC/static/'
STATIC_ROOT = ''
...
SECRET_KEY = 'p%jodl(mex3r(131*#m&amp;6n()5ifyqkgx9qw&amp;a@&amp;eq#5^h*0^d0'
...
ROOT_URLCONF = 'MSZ_SKLCC.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'MSZ_SKLCC.wsgi.application'
